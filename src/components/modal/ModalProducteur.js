"use client";
import { useProducteur } from "../../hooks/useProducteur";
import { Save, X } from "lucide-react";

export default function ModalProducteur({ onClose }) {
  const {
    data,
    handleChange,
    handleSubmit,
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 max-w-md mx-auto relative">
      ...
      {success && <p className="text-green-600 mt-3">Producteur enregistré.</p>}
